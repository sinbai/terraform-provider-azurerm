...
func TestAccFleetLinux_scalingAutoScale(t *testing.T) {
...
func TestAccFleetLinux_scalingCapacityReservationGroupId(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_defaultInstanceCount(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}

	data.ResourceTest(t, r, []acceptance.TestStep{
		{
			Config: r.defaultInstanceCount(data),
			Check: acceptance.ComposeTestCheckFunc(
				check.That(data.ResourceName).ExistsInAzure(r),
			),
		},
...
func TestAccFleetLinux_scalingHostGroupId(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_scalingInstanceCount(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_scalingOverProvisionDisabled(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_scalingProximityPlacementGroup(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_scalingSinglePlacementGroupDisabled(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_scalingSinglePlacementGroupDisabledUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_scalingUpdateSku(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_scalingZonesSingle(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_scalingZonesMultiple(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_scalingZonesUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_scalingZonesBalance(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func (r AzureFleetResource) scalingAutoScale(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
resource "azurerm_monitor_autoscale_setting" "test" {
  ...
  resource_group_name = azurerm_resource_group.test.name
  location            = azurerm_resource_group.test.location
  target_resource_id  = azurerm_azure_fleet.test.id
  ...
  profile {
    ...
    rule {
      metric_trigger {
        ...
        metric_resource_id = azurerm_azure_fleet.test.id
        time_grain         = "PT1M"
        statistic          = "Average"
        time_window        = "PT5M"

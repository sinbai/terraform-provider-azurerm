...
func TestAccFleetLinux_imagesAutomaticUpdate(t *testing.T) {
...
func TestAccFleetLinux_imagesDisableAutomaticUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_imagesFromCapturedVirtualMachineImage(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_imagesManualUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_imagesManualUpdateExternalRoll(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_imagesRollingUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_imagesPlan(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func (r AzureFleetResource) imagesAutomaticUpdate(data acceptance.TestData, offer, sku string) string {
	return fmt.Sprintf(`
%s
...
func (r AzureFleetResource) imagesFromVirtualMachinePrerequisitesWithImage(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r AzureFleetResource) imagesFromVirtualMachine(data acceptance.TestData, image string) string {
	return fmt.Sprintf(`
%s
...
func (r AzureFleetResource) imagesManualUpdate(data acceptance.TestData, offer, sku string) string {
	return fmt.Sprintf(`
%s
...
`, r.templateLinuxWithOutProvider(data), data.RandomInteger, offer, sku)
}

func (r AzureFleetResource) imagesRollingUpdate(data acceptance.TestData, offer, sku string) string {
	return fmt.Sprintf(`
%s
...
func (r AzureFleetResource) cancelExistingAgreement(publisher string, offer string, sku string) acceptance.ClientCheckFunc {

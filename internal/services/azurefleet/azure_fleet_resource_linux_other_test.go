...
func TestAccFleetLinux_otherBootDiagnostics(t *testing.T) {
...
func TestAccFleetLinux_otherBootDiagnosticsManaged(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherComputerNamePrefix(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherComputerNamePrefixInvalid(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherCustomData(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherEdgeZone(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherUserData(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherForceDelete(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherPrioritySpotDeallocate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherPrioritySpotDelete(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherPrioritySpotMaxBidPrice(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherPriorityRegular(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherRequiresImport(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherSecret(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherSpotRestoreDefault(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherSpotRestore(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherTags(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherVMAgent(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherVMAgentDisabled(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherVMAgentDisabledWithExtensionDisabled(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherScaleInPolicy(t *testing.T) {
...
func TestAccFleetLinux_otherScaleIn(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherTerminationNotification(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
// TODO remove TestAccFleetLinux_otherTerminationNotificationMigration in 4.0
func TestAccFleetLinux_otherTerminationNotificationMigration(t *testing.T) {
	if features.FourPointOhBeta() {
...
func TestAccFleetLinux_otherAutomaticRepairsPolicy(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
	data.ResourceTest(t, r, []acceptance.TestStep{
		{
...
func TestAccFleetLinux_otherUpgradeMode(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherEncryptionAtHost(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherEncryptionAtHostUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherEncryptionAtHostWithCMK(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherPlatformFaultDomainCount(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherRollingUpgradePolicyUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherHealthProbeUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherSecureBootEnabled(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherVTpmEnabled(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherGalleryApplicationBasic(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherGalleryApplicationComplete(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherCancelRollingUpgrades(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_otherDisableReimageOnManualUpgrade(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func (r AzureFleetResource) otherBootDiagnostics(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
`, r.templateLinuxWithOutProvider(data), data.RandomInteger)
}

func (r AzureFleetResource) otherPrioritySpot(data acceptance.TestData, evictionPolicy string) string {
	return fmt.Sprintf(`
%s
...
resource "azurerm_azure_fleet" "import" {
  ...
  sku                 = azurerm_azure_fleet.test.sku
  instances           = azurerm_azure_fleet.test.instances
  admin_username      = azurerm_azure_fleet.test.admin_username
  admin_password      = azurerm_azure_fleet.test.admin_password
...
func (r AzureFleetResource) otherSecretRemoved(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r AzureFleetResource) otherSecretUpdated(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r AzureFleetResource) otherSecretTemplate(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r AzureFleetResource) otherTerminateNotification(data acceptance.TestData, enabled bool) string {
	return fmt.Sprintf(`
%s
...
func (r AzureFleetResource) otherPlatformFaultDomainCount(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r AzureFleetResource) otherGalleryApplicationComplete(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r AzureFleetResource) otherGalleryApplicationTemplate(data acceptance.TestData) string {
	return fmt.Sprintf(`
%[1]s
...
`, r.templateLinuxWithOutProvider(data), data.RandomInteger, sku)
}

...
func TestAccFleetLinux_extensionDoNotRunExtensionsOnOverProvisionedMachines(t *testing.T) {
...
func TestAccFleetLinux_extensionDoNotRunExtensionsOnOverProvisionedMachinesUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_extensionBasic(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_extensionOnlySettings(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_extensionForceUpdateTag(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_extensionsMultiple(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_extensionsUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_extensionsRollingUpgradeWithHealthExtension(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_extensionsAutomaticUpgradeWithHealthExtension(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_extensionAutomaticUpgradeUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_extensionWithTimeBudget(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_extensionWithTimeBudgetUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_extensionTimeBudgetWithoutExtensions(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_extensionTimeBudgetWithoutExtensionsUpdate(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_extensionsAutomaticUpgradeWithServiceFabricExtension(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_extensionAutomaticUpgradeEnabled(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_extensionOperationsEnabled(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_extensionOperationsDisabled(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func TestAccFleetLinux_extensionProtectedSettingsFromKeyVault(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_azure_fleet", "test")
	r := AzureFleetResource{}
...
func (r AzureFleetResource) extensionDoNotRunExtensionsOnOverProvisionedMachines(data acceptance.TestData, enabled bool) string {
	return fmt.Sprintf(`
%s
...
func (r AzureFleetResource) extensionProtectedSettingsFromKeyVaultUpdated(data acceptance.TestData) string {
	return r.extensionProtectedSettingsFromKeyVaultTemplate(data, 1)
}

func (r AzureFleetResource) extensionProtectedSettingsFromKeyVaultTemplate(data acceptance.TestData, index int) string {
	return fmt.Sprintf(`
%[1]s
...
`, r.templateLinuxWithOutProvider(data), data.RandomInteger, data.RandomString, index)
}

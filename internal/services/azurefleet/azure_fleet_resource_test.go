...
resource "azurerm_azure_fleet" "test" {
 ...
 require_guest_provision_signal_enabled = true
 os_profile_secrets {
  ...
  compute_profile {
    ...
    virtual_machine_profile {
      ...
      os_profile {
        ...
        custom_data_base64             = ""
        require_guest_provision_signal_enabled = false
        linux_configuration {
...
func (r AzureFleetResource) completebackup(data acceptance.TestData) string {
	template := r.template(data)
	return fmt.Sprintf(`
%[1]s

...
func TestAccApiManagementWorkspaceApi_apiTypes(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_api_management_workspace_api", "test")
	r := ApiManagementWorkspaceApiTestResource{}
...
func TestAccApiManagementWorkspaceApi_importOpenapi(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_api_management_workspace_api", "test")
	r := ApiManagementWorkspaceApiTestResource{}
...
func TestAccApiManagementWorkspaceApi_importWsdl(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_api_management_workspace_api", "test")
...
func (r ApiManagementWorkspaceApiTestResource) graphql(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
func (r ApiManagementWorkspaceApiTestResource) soap(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
func (r ApiManagementWorkspaceApiTestResource) websocket(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
resource "azurerm_api_management_workspace_api" "test" {
  ...
  api_management_workspace_id = azurerm_api_management_workspace.test.id
  api_type     = "websocket"
  display_name = "Test WebSocket API"
  path         = "websocket"
  protocols    = ["wss"]
  revision     = "1"
  service_url  = "wss://example.com/api"
}
`, r.template(data), data.RandomInteger)
}

func (r ApiManagementWorkspaceApiTestResource) oauth2Authorization(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
resource "azurerm_api_management_workspace_api" "test" {
  ...
  oauth2_authorization {
    authorization_server_name = "test-server"
    scope                     = "read write"
  }
}
`, r.template(data), data.RandomInteger)
...
func (r ApiManagementWorkspaceApiTestResource) oauth2AuthorizationUpdated(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
func (r ApiManagementWorkspaceApiTestResource) openidAuthentication(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
func (r ApiManagementWorkspaceApiTestResource) openidAuthenticationUpdated(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
func (r ApiManagementWorkspaceApiTestResource) importSwagger(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
func (r ApiManagementWorkspaceApiTestResource) importOpenapi(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
func (r ApiManagementWorkspaceApiTestResource) importWsdl(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s

...
func TestAccApiManagementGatewayConfigConnection_update(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_api_management_gateway_config_connection", "test")
	r := ApiManagementGatewayConfigConnectionResource{}
...
func (r ApiManagementGatewayConfigConnectionResource) update(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}

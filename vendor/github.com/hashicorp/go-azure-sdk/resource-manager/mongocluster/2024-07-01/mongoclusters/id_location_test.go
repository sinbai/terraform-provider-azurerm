...
func TestFormatLocationID(t *testing.T) {
	...
	expected := "/subscriptions/12345678-1234-9876-4563-123456789012/providers/Microsoft.DocumentDB/locations/locationValue"
	if actual != expected {
...
func TestParseLocationID(t *testing.T) {
	testData := []struct {
		...
		},
		{
			...
			Input: "/subscriptions/12345678-1234-9876-4563-123456789012/providers/Microsoft.DocumentDB/locations/locationValue/extra",
			Error: true,
		},
	}
